...
#include "ui_narackivnes.h"

NarackiVnes::NarackiVnes(BaseForm *parent) :
    BaseForm(parent),
    ui(new Ui::NarackiVnes)
    ,hlp(0)
...
NarackiVnes::~NarackiVnes()
{
    delete hlp;
    delete ui;
}
void NarackiVnes::pressEscape()
{
...
void NarackiVnes::getResultEX(QStringList& tlist)
{
...
void NarackiVnes::on_pushButton_clicked()
{
...
void NarackiVnes::setFocusArtikal(QString t)
{
    ui->lineEdit_2->setFocus();
...
void NarackiVnes::setFocusKomintent(QString t)
{
