...
void PovratniciVnes::getResultEX(QStringList& tlist)
{
...
void PovratniciVnes::on_pushButton_clicked()
{
...
void PovratniciVnes::setFocusKomintent(QString t)
{
